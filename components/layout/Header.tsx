...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      <div className="header-top-bar d-none d-xl-flex align-items-center justify-content-center gap-4 px-4 px-md-5">
        <a href="mailto:info@perumagictravel.com" className="text-white text-decoration-none d-flex align-items-center gap-1 small">
          <Mail size={14} />
          info@perumagictravel.com
        </a>
        <a href="tel:+51900000000" className="text-white text-decoration-none d-flex align-items-center gap-1 small">
          <Phone size={14} />
          +51 900 000 000
        </a>
        <div className="d-flex gap-3 ms-3">
          <a href="#" className="text-white text-decoration-none small" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
          ...
          <a href="#" className="text-white text-decoration-none small" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
          ...
          <a href="#" className="text-white text-decoration-none small" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
          ...
          <div className="collapse navbar-collapse" id="mainNav">
              ...
              {pagesData
                ...
                .map(page => (
                  <li className="nav-item" key={page.id}>
                    <Link className="nav-link text-dark py-3" href={`/${page.slug}`}>
                      {page.title}
                    </Link>
                  </li>
                ))}
            ...
            <div className="d-flex align-items-xl-center align-items-start flex-column flex-xl-row gap-3 ms-xl-4 py-3 py-xl-0">
              <Link
                ...
                style={{ backgroundColor: "#0b6635", fontSize: "13px", padding: "10px 22px", borderRadius: "5px", letterSpacing: "0.5px" }}
              >
                Plan Your Trip
              </Link>
